...
`build_vi.py` produces `VIEDIT.COM` (20992 bytes) and `VIEDIT.SYM` here. The
...
- **Build:** reproducible (VIEDIT.COM = 20992 bytes; KEYTST also builds).
...
- **Smoke test:** 332 passed / 0 failed at `MAX_LIVE=20`.
