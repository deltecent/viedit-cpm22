...
`build_vi.py` produces `VIEDIT.COM` (22656 bytes) and `VIEDIT.SYM` here. The
...
- **Build:** reproducible (VIEDIT.COM = 22656 bytes; KEYTST also builds).
...
- **Smoke test:** 385 passed / 0 failed at `MAX_LIVE=20`.
