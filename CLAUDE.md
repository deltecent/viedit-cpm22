...
`build_vi.py` produces `VIEDIT.COM` (22912 bytes) and `VIEDIT.SYM` here. The
...
- **Build:** reproducible (VIEDIT.COM = 22912 bytes; KEYTST also builds).
...
- **Smoke test:** 433 passed / 0 failed at the default `MAX_LIVE=4`.
