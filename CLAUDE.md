...
`build_vi.py` produces `VIEDIT.COM` (22528 bytes) and `VIEDIT.SYM` here. The
...
- **Build:** reproducible (VIEDIT.COM = 22528 bytes; KEYTST also builds).
...
- **Smoke test:** 379 passed / 0 failed at `MAX_LIVE=20`.
